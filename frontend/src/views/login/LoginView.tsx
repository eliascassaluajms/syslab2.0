      ...
      <div className="w-full max-w-md space-y-8 rounded-2xl bg-gray-900 p-8 shadow-2xl border border-gray-800">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-400">
            Facultad de Ciencias Integradas de Yacuiba - UAJMS
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            ...
            {/* Campo: Contraseña con Ojito Dinámico */}
            <div className="flex flex-col">
              <label className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">
                Contraseña
              </label>
              <div className="relative w-full">
                <input
                  type={showPassword ? 'text' : 'password'} // Alterna dinámicamente el tipo de campo
                  required
                  value={password}
