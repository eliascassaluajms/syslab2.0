...
export default function LoginScreen({ navigation }: Props) {
  ...
  const enviar = async () => {
    ...
    try {
      ...
      await iniciarSesion(sesion.token, sesion.usuario);
    } catch (e) {
    ...
    <View style={estilos.contenedor}>
      <ScrollView contentContainerStyle={estilos.cuerpo} keyboardShouldPersistTaps="handled">
        <View style={estilos.marca}>
          ...
          <Text style={estilos.nombreApp}>SysLab Estudiante</Text>
          <Text style={estilos.eslogan}>Acceso a tu horario, asistencia y equipos de laboratorio</Text>
        </View>
